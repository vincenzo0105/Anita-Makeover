    ...
    <div className="privacy-container">
      ...
      <div className="privacy-card">
        ...
        <ul>
          ...
          <li>Send updates regarding services and confirmations</li>
        </ul>
        ...
        <p>
          ...
          shared with trusted service providers such as hosting platforms and
          database services solely for operational purposes.
        </p>
        ...
        <p>
          Our website may contain links to third-party platforms such as social
        ...
        <p><strong>Artistry by Anita Kumavat</strong></p>
        <p>Email: anitakumavat24@gmail.com</p>
        <p>Phone: +91 8369394088</p>
        <p>Location: Kalyan West, Maharashtra, India</p>
